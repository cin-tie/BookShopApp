...
struct BookShopAppApp: App {
    ...
    init() {
        ...
        if ProcessInfo.processInfo.arguments.contains("UI_TESTING_LOGGED_IN") {
            SessionService.shared.loginForUITests()
        }
    }
    ...
    var body: some Scene {
        WindowGroup {
            ...
            if ProcessInfo.processInfo.arguments.contains("UI_TESTING") {
                ...
                if ProcessInfo.processInfo.arguments.contains("LOGGED_IN") {
                    MainTabView()
